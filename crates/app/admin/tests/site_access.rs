...
async fn removing_your_own_device_erases_its_key_roster_line_and_binding() {
    ...
    assert_eq!(selfhost_admin::peer_binding::owner_of(&box_.dir, "bob-laptop"), None, "binding gone");
...
async fn a_caller_can_neither_see_nor_remove_someone_elses_device() {
    ...
    assert_eq!(selfhost_admin::peer_binding::owner_of(&box_.dir, "bob-laptop").as_deref(), Some("bob"));
