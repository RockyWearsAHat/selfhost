/* Withdrawing a report: the inline confirmation, which needs a second press. */
window.__STATE = {
  "hash": "#mine",
  "routes": {
    "GET /capabilities": {
...
window.addEventListener("load", function () {
  setTimeout(function () {
    var head = document.querySelector(".entry-head");
    if (head) head.click();
    setTimeout(function () {
      var buttons = document.querySelectorAll(".entry-body .btn-danger");
